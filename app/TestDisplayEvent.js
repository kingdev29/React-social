...
var TestEventDisplay = React.createClass({
				...
				<div className="col">
					...
					<h2 className="create-title">Create Event</h2>
						<form className="eventAdd">
							...
							<input type='text' ref='eventName' defaultValue={this.state.eventName} placeholder="Event Name" className={'form-control'} /><br />
							<Maps/>
							<input type='text' onFocus={this.locationInputHandle} ref='eventLocation' defaultValue={this.state.eventLocation} className='form-control' placeholder="Location"/><br />
							<input type='time' ref='eventTime' defaultValue={this.state.eventTime} className={'form-control'} placeholder="Time"/><br />
							<textarea type='text' ref='eventDescription' defaultValue={this.state.eventDescription} className={'form-control'} placeholder="Description"/><br />
